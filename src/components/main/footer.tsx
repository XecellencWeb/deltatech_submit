...
const Footer = () => {
  return (
    ...
    <div className="col-span-10 mb-12 flex justify-between max-lg:flex-col lg:items-center gap-2">
        <div className="flex flex-col">
        <img src="/imgs/logo.jpg" className="w-56"/>
